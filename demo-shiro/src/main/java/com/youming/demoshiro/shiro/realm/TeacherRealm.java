...
public class TeacherRealm extends AuthorizingRealm{
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		logger.info("授权调用Teacher：" + principals.toString());
		...
		simpleAuthorizationInfo.addStringPermission("teacher:info:read");
		simpleAuthorizationInfo.addStringPermission("teacher:info:insert"); // 添加3个权限
		simpleAuthorizationInfo.addStringPermission("teacher:info:update");
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		principalMap.put("userType", "teacher");
