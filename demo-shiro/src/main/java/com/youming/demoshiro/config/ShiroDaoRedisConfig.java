...
import com.youming.demoshiro.shiro.session.mgt.eis.RedisSessionDAO;
...
public class ShiroDaoRedisConfig {
	...
	public SessionManager sessionManager() {
		...
		sessionManager.setSessionDAO(this.springUtils.getApplicationContext().getBean(RedisSessionDAO.class)); // 设置Redis保存Session
