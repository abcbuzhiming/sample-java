package com.youming.sample.spring.boot.redis.config;
...
@ComponentScan(basePackages = { "com.youming.sample.spring.boot.redis" }, excludeFilters = {
		@Filter(type = FilterType.ANNOTATION, value = Configuration.class) }) // 自动扫描包范围,相当于xml配置:context:component-scan
//@Import({ RedisConfig.class, }) // 注入缓存配置类
