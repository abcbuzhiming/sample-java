...
public class GeneratorOracle {
	...
	public static void main(String[] args) {
		...
		String dbUsername = "whutpds"; // 数据库账号
		String dbPassword = "oracle_WHUT_youming_896"; // 数据库账号
		String dbUrl = "jdbc:oracle:thin:@127.0.0.1:1521/orcl"; // 数据库地址
		// 数据库驱动名称OracleDriver
		String dbDriverClassName = "oracle.jdbc.driver.OracleDriver";
		//String schemaName = "WHUTPDS";		//模式名称(oracle下，一个用户拥有自己的模式)
		...
		packageConfig.setParent("com.youming.whut.project.declare.data.base"); // 在这里，请把project.name改成你自己的项目包名字符串比如:whut.teach.system
